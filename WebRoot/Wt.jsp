...
<div class="nav-down">
    ...
    <div class="rightcon">
    	<div class="right_con">
        	...
        	<p style="text-align:left; margin-top:50px;margin-left:300px;font-size:30px">论坛管理</p>
        	<p></p>
<%
...
try
{
rs=(ResultSet)stmt.executeQuery("select * from reporttable");
...
<tr bgcolor="#4F81BD"style="color: #fff;">
   ...
   <td id="I<%=i %>"><%=rs.getString("mainid") %></td>
  <td><%=rs.getString("reporter")%></td>   
   <td> <%=rs.getString("reportacc")%></td>   
...
window.location="delete1.jsp?id="+b;
}
</script>
<script>
function xiangqing<%=i %>(){
      var b=document.getElementById("I<%=i %>").valueOf().innerHTML;
